...
# Define constants for sensor registers and settings
...
def bme_set_bits(reg_data, bitname_msk, bitname_pos, data):
    """
    Macro to set bits in a register
...
class Adafruit_BME680:
    """Driver for BME680 air quality sensor
    ...
    def __init__(self, *, refresh_rate: int = 10) -> None:
        ...
        self._amb_temp = 25  # Ambient temperature
        self.set_gas_heater(320, 150)  # Heater set to 320 deg C for 150 msec
    ...
    def gas(self) -> int:
        ...
        if self._chip_variant == 0x01:
            # Calculation for gas resistance
    ...
    def _calc_res_heat(self, temp: int) -> int:
        """
        Calculate the heater resistance value using float
        """
...
class BME680_I2C(Adafruit_BME680):
    ...
    **Quickstart: Importing and using the BME680**
        ...
        Here is an example of using the :class:`BME680_I2C` class.
...
class BME680_SPI(Adafruit_BME680):
    ...
    **Quickstart: Importing and using the BME680**
        ...
        Here is an example of using the :class:`BME680_SPI` class.
        First you will need to import the libraries to use the sensor
